...
const s = {
  ...
  pendingBox: { background: ALPHA.accentSubtle, border: `1px solid ${ALPHA.accentBorder}`, borderRadius: RADIUS.lg, padding: '14px 16px', fontSize: 13, color: COLORS.textMuted, lineHeight: 1.6, marginTop: 12 },
};
